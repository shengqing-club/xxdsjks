...
async function check() {
  ...
  if (parseInt(studentCount.rows[0].count) > 0 && parseInt(studentsCount.rows[0].count) > 0) {
  ...
  if (parseInt(gradeCount.rows[0].count) > 0 && parseInt(gradesCount.rows[0].count) > 0) {
